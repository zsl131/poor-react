      ...
      <Modal {...this.props}  style={{ "minWidth": '80%', top: 20 }} onOk={handleOk}>
        <Form layout="horizontal">
          ...
          <FormItem {...formItemLayout} label="图片">
            <PictureWall onBeforeUpload={onBeforeUpload} accept="image/png, image/jpeg, image/gif" fileList={this.state.fileList} showMsg="背景大图" data={{'extra':'w:1800_h:1800'}} onFileChange={onFileChange}/>
          </FormItem>
