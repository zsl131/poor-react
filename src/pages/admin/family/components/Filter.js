    ...
    <Form layout="inline" onSubmit={handleSubmit}>
      ...
      <FormItem>
        {getFieldDecorator("xb")(
          <Select style={{width: 120}} defaultActiveFirstOption={true} placeholder="户主性别">
      ...
      <FormItem>
        {getFieldDecorator("lx")(
          <Select style={{width: 120}} defaultActiveFirstOption={true} placeholder="家庭属性">
            <Option value="">==全部==</Option>
            <Option value="卡户">卡户</Option>
            <Option value="随迁户">随迁户</Option>
          </Select>
        )}
      </FormItem>
      <FormItem>
