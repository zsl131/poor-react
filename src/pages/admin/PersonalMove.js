...
//搬迁
export default class PersonalMove extends React.Component {
      ...
      <div className={styles.singleBlock}>
        ...
        <table>
          ...
          <tr>
            ...
            <td className={styles.value} colSpan={3}>{personal.bqsj}</td>

            <td className={styles.label}>搬迁地点</td>
            <td className={styles.value} colSpan={3}>{personal.bqdd}</td>
          </tr>
          <tr>
            <td className={styles.label}>备注</td>
            <td className={styles.value} colSpan={7}>{personal.bz}</td>
          </tr>
          </tbody>
        </table>
      </div>
