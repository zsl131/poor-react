...
export default class UpdateModal extends React.Component {
  ...
  render() {
    ...
    const isHuZhu = item.sfzh===item.hzsfzh; //是否是户主
    ...
    return(
      <Modal {...this.props}  style={{ "minWidth": '96%', top: 10 }} footer={null}>
        <Tabs defaultActiveKey="1">
          ...
          {isHuZhu && <TabPane tab={"搬迁信息"} key="3"><UpdateMove {...moveOpts}/></TabPane>}
          ...
          {isHuZhu && <TabPane tab={"产业情况"} key="8"><UpdateIndustry {...industryOpts}/></TabPane>}
