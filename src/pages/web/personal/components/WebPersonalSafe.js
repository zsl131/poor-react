...
//保险
export default class WebPersonalSafe extends React.Component {
    ...
    return(
      <div className={styles.singleBlock}>
        ...
        <table>
          <tbody>
          <tr>
            <td className={styles.label} style={{"width":"auto"}}>健康状况</td>
            <td className={styles.value}>{personal.jkzk}</td>

            <td className={styles.label} style={{"width":"auto"}}>居民养老保险</td>
            <td className={styles.value} >{personal.sfylbx}</td>
          </tr>
          <tr>
